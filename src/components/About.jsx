...
<path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    ...
                    <div className="card-body">
                        <h2 className="card-title text-black text-center text-extrabold pt-4 ">HeadCoach's word</h2>
...
First and foremost, my coaching philosophy emphasizes the importance of developing a strong
